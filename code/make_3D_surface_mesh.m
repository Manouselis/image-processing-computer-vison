function [TR, J1l] = make_3D_surface_mesh(disparityMap, ptCloud_pair1, unreliable, J1)
...
%% Unionizing the array of unreliable points used previously with any new unreliable points of the point cloud
